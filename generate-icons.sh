...
# Script to generate all the icons for the MIDI Keyboard Web App

echo "Generating icons for the MIDI Keyboard Web App..."
...
{
  "name": "MIDI Keyboard Web App",
  "short_name": "MIDIKeyboard",
  "start_url": "./index.html",
  "display": "standalone",
  "theme_color": "#1a2a6c",
  "background_color": "#1a2a6c",
  "description": "Comprehensive MIDI Keyboard Web App",
  "icons": [
    {
